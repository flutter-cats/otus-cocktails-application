...
class _Banner extends StatelessWidget {
  _Banner({Key? key, required String this.srcImage}) : super(key: key);
  final IconData iconBack = Icons.arrow_back;
  final IconData iconOut = Icons.arrow_circle_up_outlined;
  final srcImage;
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              IconButton(onPressed: () {}, icon: Icon(iconBack)),
              IconButton(onPressed: () {}, icon: Icon(iconOut)),
            ],
          ),
        ));
  }
...
class _CoctailInfo extends StatelessWidget {
  ...
  final IconData _iconHart = Icons.star;

  static Widget _buildMainInfo({required String title, required String text}) {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    IconButton(icon: Icon(_iconHart), onPressed: () {})
                  ],
                ),
                Text(
                  id,
...
class _Ingredients extends StatelessWidget {
  const _Ingredients({Key? key, required this.ingredients}) : super(key: key);
  ...
  static _buildIngredient(
      {required String ingredient, required String mesure}) {
    return Padding(
...
class _Instruction extends StatelessWidget {
  const _Instruction({Key? key, required this.instruction}) : super(key: key);
