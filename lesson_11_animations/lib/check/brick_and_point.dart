  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: SimpleBlockTapAnimation(),
      ),
    );
  }
}

class SimpleBlockTapAnimation extends StatefulWidget {
  @override
  _SimpleBlockTapAnimationState createState() =>
      _SimpleBlockTapAnimationState();
}

class _SimpleBlockTapAnimationState extends State<SimpleBlockTapAnimation> {
