...
class MaterialDialogsSample2 extends StatefulWidget {
  @override
  _MaterialDialogsSample2State createState() => _MaterialDialogsSample2State();
}

class _MaterialDialogsSample2State extends State<MaterialDialogsSample2> {
  @override
