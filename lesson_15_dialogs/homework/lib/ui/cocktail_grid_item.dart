...
import 'package:homework/ui/cocktail_detail_page/cocktail_detail_page.dart';
        ...
        children: [
          ...
          Material(
            ...
            child: InkWell(
              ...
              onTap: () {
                _navigateToDetailPage(context, cocktailDefinition.id);
              },
            ),
          )
        ],
  ...
  void _navigateToDetailPage(BuildContext context, String cocktailId) async {
    ...
    if (_cocktail != null) {
      Navigator.of(context).push(MaterialPageRoute(builder: (context) {
        return CocktailDetailPage(_cocktail!);
      }));
    }
