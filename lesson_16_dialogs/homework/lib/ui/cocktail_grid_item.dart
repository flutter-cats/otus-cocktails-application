...
import 'package:homework/core/string_callback.dart';

class CocktailGridItem extends StatelessWidget {
  const CocktailGridItem(this.cocktailDefinition, {this.callback, Key? key}) : super(key: key);

  static const double aspectRatio = 170 / 215;
  final CocktailDefinition cocktailDefinition;
  final VoidCallbackWithString? callback;

  @override
  Widget build(BuildContext context) {
    return InkResponse(
      onTap: () => _onTap(context, cocktailDefinition.id),
      child: ClipRRect(
