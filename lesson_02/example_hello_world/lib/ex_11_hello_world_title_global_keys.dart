...
final globalKey =
    GlobalKey<HelloWorldTitleOnlyWidgetState>(debugLabel: 'title key');

void main() {
  runApp(
    GestureDetector(
      onTap: () => globalKey.currentState.updateNewState(),
...
class HelloWorldTitleOnlyWidget extends StatefulWidget {
  ...
  @override
  HelloWorldTitleOnlyWidgetState createState() =>
      HelloWorldTitleOnlyWidgetState();
}
...
class HelloWorldTitleOnlyWidgetState extends State<HelloWorldTitleOnlyWidget> {
  ...
  void updateNewState() {
    setState(() => _title = DateTime.now().toString());
  }
}
