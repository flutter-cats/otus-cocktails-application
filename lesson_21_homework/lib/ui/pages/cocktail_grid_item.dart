...
class CocktailGridItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final provider = BlocProvider.of<FavoriteCubit>(context);
    bool isFavorite = cocktailDefinition.isFavourite!;
                          ...
                          children: [
                            ...
                            isFavorite
                                ? IconButton(
                                    ...
                                    onPressed: () {
                                      debugPrint('click');
                                      provider.removeFromFavoriteByDefinition(
                                          cocktailDefinition);
                                    },
                                  )
                                : IconButton(
                                    ...
                                    onPressed: () {
                                      debugPrint('click');
                                      provider.addToFavoriteByDefinition(
                                          cocktailDefinition);
                                    },
                                  ),
                          ],
