...
class CategoriesFilterBarDelegate extends SliverPersistentHeaderDelegate {
  CategoriesFilterBarDelegate(this.categories, {this.onCategorySelected, this.selectedCategory});
...
class CategoriesFilterBar extends StatelessWidget {
  const CategoriesFilterBar(this.categories, {Key key, this.onCategorySelected, this.selectedCategory})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
        ...
        itemBuilder: (ctx, index) =>
            _categoryItemBuilder(context, categories.elementAt(index), categories.elementAt(index) == selectedCategory),
