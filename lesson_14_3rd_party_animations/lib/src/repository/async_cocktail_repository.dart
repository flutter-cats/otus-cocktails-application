...
import 'package:lesson_14_3rd_party_animations/src/dto/cocktail_dto.dart';
import 'package:lesson_14_3rd_party_animations/src/model/cocktail.dart';
import 'package:lesson_14_3rd_party_animations/src/model/cocktail_category.dart';
import 'package:lesson_14_3rd_party_animations/src/model/cocktail_type.dart';
import 'package:lesson_14_3rd_party_animations/src/model/glass_type.dart';
import 'package:lesson_14_3rd_party_animations/src/model/ingredient_definition.dart';
...
class AsyncCocktailRepository {
  ...
  Future<Cocktail?> getRandomCocktail() async {
    ...
    var url = Uri.parse('https://the-cocktail-db.p.rapidapi.com/random.php');
