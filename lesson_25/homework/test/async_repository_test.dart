...
void main() {
  group('async repository test', () {
    ...
    test('get cocktail by valid id', () async {
      ...
      expect(await repository.fetchCocktailDetails(validId), null);
    ...
    test('get cocktail by invalid id', () async {
      ...
      expect(repository.fetchCocktailDetails(invalidId), throwsException);
    });
    ...
    test('fetch cocktails by category', () async {
      ...
      final cocktails =
          await repository.fetchCocktailsByCocktailCategory(category);
