...
class SyncCocktailRepository {
  //static late Iterable<Cocktail> _innerCache;
  ...
  Cocktail getHomeworkCocktail() {
    return Cocktail(
      ...
      instruction: '- В большом бокале смешайте порванные листья мяты,'
          ...
          '\n'
          '- Добавьте мелко нарезанную кубиками мякоть арбуза и снова слегка '
          'растолките.'
          '\n'
          '- Добавьте ром и лед. Перемешайте и разлейте по бокалам. Сразу '
          'подавайте.',
      isFavourite: true,
